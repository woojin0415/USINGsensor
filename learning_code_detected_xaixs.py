...
drop_path = os.path.join('/', 'home', 'cclab-server', 'Desktop', 'detectproject', 'detected_data_learning', 'x', 'drop')  # 1
pick_path = os.path.join('/', 'home', 'cclab-server', 'Desktop', 'detectproject', 'detected_data_learning', 'x', 'pickup')  # 1
walk_path = os.path.join('/', 'home', 'cclab-server', 'Desktop', 'detectproject', 'detected_data_learning', 'x', 'walk')  # 2
run_path = os.path.join('/', 'home', 'cclab-server', 'Desktop', 'detectproject', 'detected_data_learning', 'x', 'run')  # 2
pickdown_path = os.path.join('/', 'home', 'cclab-server', 'Desktop', 'detectproject', 'detected_data_learning', 'x', 'pickdown')  # 1
situp_path = os.path.join('/', 'home', 'cclab-server', 'Desktop', 'detectproject', 'detected_data_learning', 'x', 'standup')  # 1
sitdown_path = os.path.join('/', 'home', 'cclab-server', 'Desktop', 'detectproject', 'detected_data_learning', 'x', 'sitdown')  # 1
falldown_path = os.path.join('/', 'home', 'cclab-server', 'Desktop', 'detectproject', 'detected_data_learning', 'x', 'falldown')  # 1
stop_path = os.path.join('/', 'home', 'cclab-server', 'Desktop', 'detectproject', 'detected_data_learning', 'x', 'stop')  # 1
...
def learning(MLP_ch, CNN_ch, SVM_ch, axis):
    ...
    path = ""
    if axis == 'x':
        path = 'detected/x/default model/X-axis models/'
    elif axis == 'y':
    ...
    if MLP_ch == 1:
        MLP.mlp(train_input, train_output, 15, 100, path + "mlp.h5", input_shape=30)
    if SVM_ch == 1:
...
def learning_DWT(MLP_ch, CNN_ch, SVM_ch, iter, axis):
    ...
    path = ""
    if axis == 'x':
        path = 'detected/x/DWT model/X-axis models/'
    elif axis == 'y':
        path = 'detected/x/DWT model/Y-axis models/'
    elif axis == 'z':
...
def learning_kalman(MLP_ch, CNN_ch, SVM_ch, axis):
    ...
    path = ""
    if axis == 'x':
        path = 'detected/x/kalman model/X-axis models/'
    elif axis == 'y':
        path = 'detected/x/kalman model/Y-axis models/'
    elif axis == 'z':
