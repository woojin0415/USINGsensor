...
drop_path = os.path.join('/', 'home', 'cclab-server', 'Desktop', 'detectproject', 'detected_data_learning', 'z', 'drop')  # 1
pick_path = os.path.join('/', 'home', 'cclab-server', 'Desktop', 'detectproject', 'detected_data_learning', 'z', 'pickup')  # 1
walk_path = os.path.join('/', 'home', 'cclab-server', 'Desktop', 'detectproject', 'detected_data_learning', 'z', 'walk')  # 2
run_path = os.path.join('/', 'home', 'cclab-server', 'Desktop', 'detectproject', 'detected_data_learning', 'z', 'run')  # 2
pickdown_path = os.path.join('/', 'home', 'cclab-server', 'Desktop', 'detectproject', 'detected_data_learning', 'z', 'pickdown')  # 1
situp_path = os.path.join('/', 'home', 'cclab-server', 'Desktop', 'detectproject', 'detected_data_learning', 'z', 'standup')  # 1
sitdown_path = os.path.join('/', 'home', 'cclab-server', 'Desktop', 'detectproject', 'detected_data_learning', 'z', 'sitdown')  # 1
falldown_path = os.path.join('/', 'home', 'cclab-server', 'Desktop', 'detectproject', 'detected_data_learning', 'z', 'falldown')  # 1
stop_path = os.path.join('/', 'home', 'cclab-server', 'Desktop', 'detectproject', 'detected_data_learning', 'z', 'stop')  # 1
...
def learning(MLP_ch, CNN_ch, SVM_ch, axis):
    ...
    path = ""
    if axis == 'x':
        path = 'detected/z/default model/X-axis models/'
    elif axis == 'y':
        path = 'detected/z/default model/Y-axis models/'
    elif axis == 'z':
        path = 'detected/z/default model/Z-axis models/'




    if CNN_ch == 1:
        CNN.cnn(train_input, train_output, 8, 100, path + "cnn.h5", input_shape=30)
    if MLP_ch == 1:
        MLP.mlp(train_input, train_output, 8, 100, path + "mlp.h5", input_shape=30)
    if SVM_ch == 1:
...
def learning_DWT(MLP_ch, CNN_ch, SVM_ch, iter, axis):
    ...
    path = ""
    if axis == 'x':
        path = 'detected/z/DWT model/X-axis models/'
    elif axis == 'y':
        path = 'detected/z/DWT model/Y-axis models/'
    elif axis == 'z':
        path = 'detected/z/DWT model/Z-axis models/'
...
def learning_kalman(MLP_ch, CNN_ch, SVM_ch, axis):
    ...
    path = ""
    if axis == 'x':
        path = 'detected/z/kalman model/X-axis models/'
    elif axis == 'y':
        path = 'detected/z/kalman model/Y-axis models/'
    elif axis == 'z':
        path = 'detected/z/kalman model/Z-axis models/'
